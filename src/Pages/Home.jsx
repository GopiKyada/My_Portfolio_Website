...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/ll_.gopi._.kyada._ll/" },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/2e4ae6d8-30b9-400c-a5d7-798906853273/eZzWXD2z50.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Building innovative, scalable, and efficient data solutions
                  for smarter digital transformation.
                </p>
