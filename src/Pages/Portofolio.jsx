...
const techStacks = [
  ...
  { icon: "techstacks/aws.png", language: "AWS" },
  { icon: "techstacks/s3.png", language: "S3" },
  { icon: "techstacks/Glue.png", language: "Glue" },
  { icon: "techstacks/EMR.png", language: "EMR" },
  { icon: "techstacks/Redshift.png", language: "Redshift" },
  { icon: "techstacks/Athena.png", language: "Athena" },
  { icon: "techstacks/iam.png", language: "IAM" },
  { icon: "techstacks/Lambda.png", language: "Lambda" },
  { icon: "techstacks/kafka.png", language: "Kafka" },
